...
- (CGRect)getPopupFrameForViewController:(UIViewController *)viewController {
    ...
    if (UIDeviceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation)) {
        ...
        // modified by jokinryou. reset the popView's location
        // 60 is for 3.5-inch, we need other value for 4-inch
        y = ([UIScreen mainScreen].bounds.size.height - frame.size.height)/2 - 60;
    } else {
